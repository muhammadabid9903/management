...
class LeaveSummeryRejected extends StatefulWidget {
  const LeaveSummeryRejected({super.key});

  @override
  State<LeaveSummeryRejected> createState() => _LeaveSummeryRejectedState();
}

class _LeaveSummeryRejectedState extends State<LeaveSummeryRejected> {
  @override
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              SizedBox(width: 5,),
                              Text('Rejected at 22 Sept 2024',style: GoogleFonts.inter(
                                fontSize: 12,
                                fontWeight: FontWeight.w500,
