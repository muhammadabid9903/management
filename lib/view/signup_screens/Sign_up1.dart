        ...
        child: Column(
          ...
          children: [
           ...
           SizedBox(height: 20,),
            ...
            Align(
                alignment: Alignment.center,
                child: TextfieldWidget(hinttext: '+923199389472',
                    prefixicon:
                     ImageIcon(AssetImage(Appicons.email_icon),color: Appcolors.maincolor,))),
            ...
            Align(
                ...
                PassTextfieldWidget(hinttext: 'Enter Your Password',
                   // obscuretext: isHide,
                    ...
                    }, icon: isHide2?ImageIcon(AssetImage(Appicons.close_eye_icon),color: Appcolors.maincolor,):
                    Icon(Icons.remove_red_eye,color: Appcolors.maincolor,))
                    , prefixicon:ImageIcon(AssetImage(Appicons.password_icon),color: Appcolors.maincolor,))),
            SizedBox(height: 10,),
