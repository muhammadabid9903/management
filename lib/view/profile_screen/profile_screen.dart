                    ...
                    child: Column(
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            SizedBox(width: 20,),
                            Text('CONTECT',style: GoogleFonts.inter(
                              fontSize: 12,
                              fontWeight: FontWeight.w600,
                             ...
                             children: [
                               InkWell(
                                 ...
                                 child: Row(
                                   children: [
                                     SizedBox(width: 10,),
                                     Image.asset(Appicons.email_icon2,),
                                     SizedBox(width: 10,),
                                     Text('Tonald@gmail.com',style: GoogleFonts.inter(
                                       fontSize: 11,
                                       fontWeight: FontWeight.w500,
                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              InkWell(
                                onTap: (){
                                  Navigator.push(context, MaterialPageRoute(builder: (context)=>PayrollTaxScreen()));
                                },
